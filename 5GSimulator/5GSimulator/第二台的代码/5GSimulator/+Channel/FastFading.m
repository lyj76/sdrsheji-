        ...
        function obj = FastFading(...
            ...
            if ischar(PowerDelayProfile)
                ...
                switch PowerDelayProfile
                    ...
                    case 'SUI-1'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -2.4, -1.8, -2.5, -3.2, -4.5, -5.3, -6.4, -7.1, -8.5, -9.6;... 
                            0, 50e-9, 100e-9, 150e-9, 200e-9, 250e-9, 350e-9, 400e-9, 450e-9, 500e-9];
                    case 'SUI-2'
                        PowerDelayProfileINdB_DelayIndex = [
                            -3.0, -2.5, -3.0, -4.0, -5.0, -6.2, -7.4, -8.1, -9.8, -10.3;... 
                            0, 60e-9, 130e-9, 180e-9, 230e-9, 300e-9, 350e-9, 400e-9, 450e-9, 500e-9];
                    case 'SUI-3'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -5.5, -4.0, -5.5, -6.8, -8.0, -9.5, -10.2, -11.5, -12.7, -13.2;... 
                            0, 50e-9, 80e-9, 100e-9, 150e-9, 180e-9, 200e-9, 250e-9, 300e-9, 350e-9];
                    case 'SUI-4'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -3.0, -1.8, -2.6, -3.8, -5.2, -5.9, -7.2, -8.0, -9.0, -9.9;... 
                            0, 60e-9, 110e-9, 180e-9, 220e-9, 280e-9, 340e-9, 400e-9, 450e-9, 500e-9];
                    case 'SUI-5'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -4.8, -3.0, -4.3, -5.7, -6.5, -7.0, -8.0, -9.0, -10.2, -11.1;... 
                            0, 50e-9, 80e-9, 120e-9, 150e-9, 180e-9, 200e-9, 220e-9, 250e-9, 300e-9];
                    case 'SUI-6'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -2.0, -1.5, -2.0, -2.8, -3.4, -4.0, -4.5, -5.0, -5.7, -6.3;... 
                            0, 50e-9, 100e-9, 150e-9, 200e-9, 250e-9, 300e-9, 350e-9, 400e-9, 450e-9];
                    case 'COST207_UMC'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -3.6, -1.5, -2.4, -4.6, -7.2, -9.0, -10.8, -13.2, -15.0, -18.0;... 
                            0, 50e-9, 100e-9, 150e-9, 200e-9, 250e-9, 300e-9, 350e-9, 400e-9, 450e-9];
                    case 'COST207_UMa'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -3.0, -2.2, -3.5, -5.0, -7.0, -9.0, -11.0, -13.5, -16.0, -18.0;... 
                            0, 60e-9, 120e-9, 180e-9, 240e-9, 300e-9, 360e-9, 420e-9, 480e-9, 540e-9];
                    case 'COST207_SMC'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -4.0, -2.0, -3.0, -4.5, -6.5, -8.0, -10.0, -12.0, -14.0, -16.0;... 
                            0, 50e-9, 110e-9, 160e-9, 210e-9, 270e-9, 330e-9, 400e-9, 470e-9, 540e-9];
                    case 'COST207_RMC'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -4.5, -3.0, -4.2, -5.5, -7.5, -9.5, -11.0, -13.0, -15.0, -17.0;... 
                            0, 60e-9, 120e-9, 180e-9, 240e-9, 300e-9, 360e-9, 420e-9, 480e-9, 540e-9];
                    case 'ETU'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -2.5, -1.0, -3.0, -4.0, -5.0, -6.5, -8.0, -9.5, -10.0, -11.0;... 
                            0, 100e-9, 200e-9, 300e-9, 400e-9, 500e-9, 600e-9, 700e-9, 800e-9, 900e-9];
                    case 'HST'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -3.0, -1.5, -2.5, -3.5, -5.0, -6.5, -8.0, -9.0, -10.0, -11.5;... 
                            0, 50e-9, 100e-9, 150e-9, 200e-9, 250e-9, 300e-9, 350e-9, 400e-9, 450e-9];
                    case 'TDL-D'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -4.0, -2.5, -3.5, -4.0, -5.0, -6.5, -7.5, -8.5, -9.5, -11.0;... 
                            0, 100e-9, 200e-9, 300e-9, 400e-9, 500e-9, 600e-9, 700e-9, 800e-9, 900e-9];
                    case 'EPA'
                        PowerDelayProfileINdB_DelayIndex = [
                            -1.0, -2.0, -4.0, -7.0, -12.0;...  % Power in dB for each delay bin
                            0, 50e-9, 120e-9, 200e-9, 400e-9];  % Delay in seconds for each delay bin
                    case 'B2_NLOS'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -5.2 -5.4 -7.2 -8.2 -21.8 -25.5 -28.7 -20.8 -30.7 -34.9 -34.5 -31.5 -35.3 -37.5 -5.7 -7.7
                            5e-9 35e-9 140e-9 190e-9 350e-9 425e-9 430e-9 450e-9 470e-9 570e-9 605e-9 625e-9 625e-9 630e-9 1600e-9 2800e-9];
                    case 'A1_LOS'
                        PowerDelayProfileINdB_DelayIndex = [...
                            -15.1,-15.8,-13.5,-17.3,-19.2,-23.5,-18.3,-23.3,-29.1,-14.2,-21.3,-23.4;
                            5e-9,10e-9,25e-9,55e-9,65e-9,75e-9,75e-9,115e-9,115e-9,145e-9,195e-9,350e-9];
                    case 'A1_NLOS'
                        PowerDelayProfileINdB_DelayIndex = [
                            -2.2 -6.6 -2.1 -5.8 -3.3 -4.7 -4.1 -8.2 -5.2 -6.8 -10.0 -12.1 -12.4 -11.8 -20.4 -16.6
                            0e-9 5e-9 5e-9 5e-9 15e-9 15e-9 15e-9 20e-9 25e-9 40e-9 80e-9 85e-9 110e-9 115e-9 150e-9 175e-9];
                    case 'B1_LOS'
                        PowerDelayProfileINdB_DelayIndex = [
                            0.0 -12.7 -14.8 -15.8 -13.9 -17.8 -19.6 -31.4
                            0e-9 35e-9 55e-9 65e-9 105e-9 115e-9 250e-9 460e-9];
                    case 'B1_NLOS'
                        PowerDelayProfileINdB_DelayIndex = [
                            -1.0 -5.2 -6.1 -8.1 -8.6 -11.7 -12.0 -12.9 -19.6 -23.9 -22.1 -25.6 -23.3 -32.2 -31.7 -29.9
                            0e-9 95e-9 105e-9 115e-9 230e-9 240e-9 245e-9 285e-9 390e-9 430e-9 460e-9 505e-9 515e-9 595e-9 600e-9 615e-9];
            ...
            % 
            % [~,~] = PlotPowerDelayProfile(obj);
            % [~,~] = PlotFrequencyCorrelation(obj,15e3);
        end
