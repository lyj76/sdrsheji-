...
scStr.simulation.sweepValue                 = linspace(140,140,1);       % Define parameter values to sweep over. A good starting point for the pathloss is 150 to 110.
